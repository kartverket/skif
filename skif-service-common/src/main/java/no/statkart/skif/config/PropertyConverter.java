...
/**
 * A utility class to convert the configuration configuration into any type.
 *
...
public final class PropertyConverter
{
     ...
     * @throws PropertyConverterException if the value is not compatible with the requested type
     *
     * @since 1.5
     */
    static Object to(Class cls, Object value, Object[] params) throws PropertyConverterException
    {
        ...
        throw new PropertyConverterException("The value '" + value + "' (" + value.getClass() + ")"
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a boolean
     */
    public static Boolean toBoolean(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a byte
     */
    public static Byte toByte(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a short
     */
    public static Short toShort(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to an integer
     */
    public static Integer toInteger(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a Long
     */
    public static Long toLong(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a Float
     */
    public static Float toFloat(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a Double
     */
    public static Double toDouble(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a BigInteger
     */
    public static BigInteger toBigInteger(Object value) throws PropertyConverterException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a BigDecimal
     */
    public static BigDecimal toBigDecimal(Object value) throws PropertyConverterException
    {
     ...
     * @throws PropertyConverterException if the object cannot be converted
     */
    static Number toNumber(Object value, Class targetClass) throws PropertyConverterException
    {
        ...
        else
        {
            ...
            if (str.startsWith(HEX_PREFIX))
            {
                ...
                {
                    throw new PropertyConverterException("Could not convert " + str
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to an URL
     */
    public static URL toURL(Object value) throws PropertyConverterException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to an URL", e);
            }
        }
        else
        {
            throw new PropertyConverterException("The value " + value + " can't be converted to an URL");
        }
    }
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a Locale
     */
    public static Locale toLocale(Object value) throws PropertyConverterException
    {
        ...
        {
            java.util.List elements = split((String) value, '_');
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a Locale");
            }
        }
        else
        {
     ...
     */
    public static java.util.List split(String s, char delimiter, boolean trim)
    {
        if (s == null)
        {
     ...
     * @return a list with the single tokens
     */
    public static java.util.List split(String s, char delimiter)
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a Color
     */
    public static Color toColor(Object value) throws PropertyConverterException
    {
        if (value instanceof Color)
        {
            return (Color) value;
        }
        else if (value instanceof String && !isBlank((String) value))
        {
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a Color");
            }
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a Color", e);
            }
        }
        else
        {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a InetAddress
     *
     * @since 1.5
     */
    static InetAddress toInetAddress(Object value) throws PropertyConverterException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a InetAddress", e);
            }
        }
        else
        {
            throw new PropertyConverterException("The value " + value + " can't be converted to a InetAddress");
        }
    }
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to an email address
     *
     * @since 1.5
     */
    static Object toInternetAddress(Object value) throws PropertyConverterException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a InternetAddress", e);
            }
        }
        else
        {
            throw new PropertyConverterException("The value " + value + " can't be converted to a InternetAddress");
        }
    }
     ...
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to an enumeration
     *
     * @since 1.5
     */
    static Object toEnum(Object value, Class cls) throws PropertyConverterException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a " + cls.getName());
            }
        }
     ...
     * @return the converted value
     * @throws PropertyConverterException thrown if the value cannot be converted to a Calendar
     */
    public static Date toDate(Object value, String format) throws PropertyConverterException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a Date", e);
            }
        }
        else
        {
            throw new PropertyConverterException("The value " + value + " can't be converted to a Date");
        }
    }
     ...
     * @throws PropertyConverterException thrown if the value cannot be converted to a Calendar
     */
    public static Calendar toCalendar(Object value, String format) throws PropertyConverterException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new PropertyConverterException("The value " + value + " can't be converted to a Calendar", e);
            }
        }
        else
        {
            throw new PropertyConverterException("The value " + value + " can't be converted to a Calendar");
        }
    }
    ...
    public static Iterator toIterator(Object value, char delimiter)
    {
        ...
        {
            return toIterator(new ObjectArrayIterator((Object[])value), delimiter);
        }
