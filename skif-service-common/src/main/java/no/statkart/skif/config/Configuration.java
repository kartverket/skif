 ...
 * configuration of various data types. There is a generic <code>getProperty()</code>
 ...
 * <code>{@link AbstractConfiguration#setThrowExceptionOnMissing(boolean)
 ...
 * configuration because there is no way of overloading the return value.)</p>
 * <p>With the <code>addProperty()</code> and <code>setProperty()</code> methods
 * new configuration can be added to a configuration or the values of configuration
 * can be changed. With <code>clearProperty()</code> a property can be removed.
 * Other methods allow to iterate over the contained configuration or to create
...
public interface Configuration
{
    ...
    /**
     * Remove all configuration from the configuration.
     */
    void clear();

    /**
     * Gets a property from the configuration. This is the most basic get
     * method for retrieving values of configuration. In a typical implementation
     ...
     *         null if the configuration contains no mapping2 for this key.
     */
