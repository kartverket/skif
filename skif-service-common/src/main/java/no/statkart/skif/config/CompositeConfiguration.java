 ...
 * any configuration shared will mean that Configuration1 will be returned.
 * You can add multiple different types or the same type of configuration file.
...
public class CompositeConfiguration extends AbstractConfiguration implements Cloneable
{
    ...
    public void clear()
    {
        ...
        inMemoryConfiguration = new MapConfiguration();
        ((MapConfiguration) inMemoryConfiguration).setThrowExceptionOnMissing(isThrowExceptionOnMissing());
        ((MapConfiguration) inMemoryConfiguration).setListDelimiter(getListDelimiter());
        ((MapConfiguration) inMemoryConfiguration).setDelimiterParsingDisabled(isDelimiterParsingDisabled());
        configList.add(inMemoryConfiguration);
    }
...
//    }
    ...
    /**
     * Sets a flag whether added values for string configuration should be checked
    ...
    {
        ((MapConfiguration) getInMemoryConfiguration())
