 ...
 * @since 2.0
 */
public class DateTypeMapper extends AbstractTypeMapper<XMLGregorianCalendar, java.util.Date, Mapping> {

    public DateTypeMapper() {
        super(XMLGregorianCalendar.class, java.util.Date.class, Mapping.class);
    }

    // Gir en kalender som er gregoriansk hele veien, uten noe skifte til juliansk
    private GregorianCalendar createPureGregorianCalendar(java.util.Date date) {
    ...
    @Override
    public XMLGregorianCalendar mapDomainObject(java.util.Date source) {
    ...
    @Override
    public java.util.Date mapWsapiObject(XMLGregorianCalendar source) {
