...
public class JaxWsAuthenticationHandler implements LogicalHandler<LogicalMessageContext> {
    ...
    public JaxWsAuthenticationHandler(
            ...
            @SuppressWarnings("OptionalUsedAsFieldOrParameterType") // �nsker ikke � injecte null
    ...
    public boolean handleMessage(LogicalMessageContext context) {
        ...
        if (overrideHeaders != null && overrideHeaders.size() > 0) {
            // Ny logikk til bruk f.eks. ved Bearer Authorization, m� sette HTTP header(e) direkte, men ikke overskriv evt andre headere
