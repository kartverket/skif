...
public interface ModuleStrategyFactory {
    ...
    <T extends ModuleStrategy, M extends ModuleWithStrategy<T>> StrategyTuple<T> addPrototype(Class<? extends M> moduleClass, StrategyTuple<T> tuple);

    <T extends ModuleStrategy, M extends ModuleWithStrategy<T>> StrategyTuple<T> getPrototype(Class<? extends M> moduleClass);

    <T extends ModuleStrategy, M extends ModuleWithStrategy<T>> StrategyTuple<T> createStrategyTuple(Class<? extends M> moduleClass);

    <T extends ModuleStrategy, M extends ModuleWithStrategy<T>> StrategyTuple<T> createStrategyTuple(Class<? extends M> moduleClass, Configuration configuration);
