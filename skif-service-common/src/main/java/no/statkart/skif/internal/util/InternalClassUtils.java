 ...
 * SKIF-271
 *
 * Denne klassen er tatt ifra Commons Lang 2.4
 *
 * @since 2.2
 */
 ...
 * @since 2.0
 * @version $Id: InternalClassUtils.java 633621 2008-03-04 20:20:23Z mbenson $
 */
public class InternalClassUtils {
    ...
    public static String getShortClassName(Class cls) {
        if (cls == null) {
            return InternalStringUtils.EMPTY;
        }
...
//        return true;
        ...
        throw new NotImplementedException("Ikke omskrevet");
    }
    ...
    public static Class getClass(String className, boolean initialize) throws ClassNotFoundException {
        ...
        ClassLoader loader = contextCL == null ? InternalClassUtils.class.getClassLoader() : contextCL;
     ...
     *  Method method = InternalClassUtils.getPublicMethod(set.getClass(), "isEmpty",  new Class[0]);
...
//                methodName + " " + ArrayUtils.toString(parameterTypes));
    ...
    private static String toCanonicalName(String className) {
        className = InternalStringUtils.deleteWhitespace(className);
        if (className == null) {
    ...
    public static String getShortCanonicalName(String canonicalName) {
        return InternalClassUtils.getShortClassName(getCanonicalName(canonicalName));
    }
    ...
    public static String getPackageCanonicalName(String canonicalName) {
        return InternalClassUtils.getPackageName(getCanonicalName(canonicalName));
    }
