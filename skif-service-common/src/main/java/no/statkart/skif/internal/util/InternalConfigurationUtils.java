...
public final class InternalConfigurationUtils {
    ...
    /**
     * <p>Copy all configuration from the source configuration to the target
     * configuration. Properties in the target configuration are replaced with
     * the configuration with the same key in the source configuration.</p>
    ...
    /**
     * <p>Append all configuration from the source configuration to the target
     * configuration. Properties in the source configuration are appended to
     * the configuration with the same key in the target configuration.</p>
     * <p><em>Note:</em> This method is not able to handle some specifics of
     * configurations derived from <code>AbstractConfiguration</code> (e.g.
     * list delimiters). For a full support of all of these features the
     * <code>copy()</code> method of <code>AbstractConfiguration</code> should
     ...
     *         <b>null</b>, too)
     * @throws no.statkart.skif.config.ConfigurationRuntimeException if cloning is not supported for
     *                                       this object
     * @since 1.3
     */
    ...
    static File constructFile(String basePath, String fileName) {
        ...
        if (stringUtils_isEmpty(basePath) || (absolute != null && absolute.isAbsolute())) {
    ...
    public static String getBasePath(URL url) {
        ...
        if (s.endsWith("/") || stringUtils_isEmpty(url.getPath())) {
            return s;
        } else {
    ...
    public static String getFileName(URL url) {
        ...
        if (path.endsWith("/") || stringUtils_isEmpty(path)) {
            return null;
        } else {
     ...
     * <pre>
     * &lt;configuration fileName="/subdir/my.configuration"/&gt;
     * </pre>
    ...
    public static URL toURL(File file) throws MalformedURLException {
        try {
            Method toURI = file.getClass().getMethod("toURI", new Class<?>[0]);
            Object uri = toURI.invoke(file, new Object[0]);
            Method toURL = uri.getClass().getMethod("toURL", new Class<?>[0]);
            URL url = (URL) toURL.invoke(uri, new Object[0]);
