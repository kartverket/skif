...
public class ManyToOneBubbleRefType extends ManyToOneType {
    ...
    public ManyToOneBubbleRefType(String referencedEntityName, String referencedPropertyName, boolean lazy, boolean unwrapProxy, boolean embedded, boolean ignoreNotFound) {
        super(referencedEntityName + "Id", referencedPropertyName, lazy, unwrapProxy, embedded, ignoreNotFound);
