 ...
 */
public class DefaultHibernatePersistenceSession implements HibernatePersistenceSessionMaster {
    private static Logger logger = LoggerFactory.getLogger(DefaultHibernatePersistenceSession.class);
    ...
    public DefaultHibernatePersistenceSession(HibernateSessionFactoryManager sessionFactoryManager) {
