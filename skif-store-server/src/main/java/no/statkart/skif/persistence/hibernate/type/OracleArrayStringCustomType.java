...
public class OracleArrayStringCustomType extends CustomType {
    public OracleArrayStringCustomType(TypeConfiguration typeConfiguration) throws MappingException {
        super(new OracleArrayUserType<OracleArrayStringConverter, String>(new OracleArrayStringConverter()), typeConfiguration);
    }
}
