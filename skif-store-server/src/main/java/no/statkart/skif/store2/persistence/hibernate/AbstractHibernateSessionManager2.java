 ...
 */
public abstract class AbstractHibernateSessionManager2<E extends HibernateSessionManagerEntry2> implements HibernateSessionManager2 {
    private static Logger logger = LoggerFactory.getLogger(AbstractHibernateSessionManager2.class);
    protected final ConnectionFactoryManager connectionFactoryManager;
    protected final HibernateSessionFactoryManager2 hibernateSessionFactoryManager;

    protected boolean allocateConnectionsViaHibernate;

    public AbstractHibernateSessionManager2(ConnectionFactoryManager connectionFactoryManager, HibernateSessionFactoryManager2 hibernateSessionFactoryManager) {
