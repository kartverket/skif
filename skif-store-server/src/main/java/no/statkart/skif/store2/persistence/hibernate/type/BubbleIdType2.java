...
/**
 * Hibernate UserType for BubbleId2
 *
 * @author Henrik Fredholm
 * @since 0.6
 */
public abstract class BubbleIdType2 implements UserType {
    ...
    private static final boolean IS_VALUE_TRACING_ENABLED = LoggerFactory.getLogger(StringHelper.qualifier(BubbleIdType2.class.getName())).isTraceEnabled();
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
        ...
        try {
            ...
            if (rs.wasNull()) {
                ...
                BubbleId2 id = (BubbleId2) createId(value);
                if (IS_VALUE_TRACING_ENABLED) {
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index)
        ...
        try {
            if (value == null) {
                ...
                BubbleId2 bubbleId = (BubbleId2) value;
