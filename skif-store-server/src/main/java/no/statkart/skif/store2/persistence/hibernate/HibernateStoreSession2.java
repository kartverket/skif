 ...
 * @since 2.0
 */
public class HibernateStoreSession2<T extends BubbleObject2, I extends BubbleId2<? extends T>> implements StoreSession2<Session, T, I>, StorePersister2<T, I> {
    ...
    protected final <T extends BubbleObject2, I extends BubbleId2<? extends T>> void checkReplicaVersion(I bubbleId) {
     ...
     */
    private <T extends BubbleObject2, I extends BubbleId2<? extends T>> Set<T> loadAllFromDatabase(Set<I> ids) throws ObjectNotFoundException {
     ...
     */
    private <T extends BubbleObject2, I extends BubbleId2<? extends T>> Map getIdsByType(Set<I> ids) {
    ...
    private <T extends BubbleObject2, I extends BubbleId2<? extends T>> T getFromHibernateSessionOrLoad(I bubbleId) {
        T bubble;
     ...
     */
    private void ensureFullyInitialized(BubbleObject2 bubble) {
        BubbleObject2 initializedBubble = (BubbleObject2) fullyInitializedBubbles.get(bubble.getId());
   ...
   /**
     ...
     */
    private <T extends BubbleObject2, I extends BubbleId2<? extends T>> T lookupInHibernateCache(I bubbleId) {
