 ...
 * @since 2.0
 */
public class HibernateStoreSessionFactoryBuilder extends HibernateSessionFactoryBuilder {
    private static final Logger logger = LoggerFactory.getLogger(HibernateStoreSessionFactoryBuilder.class);
    private final List<Class<?>> bubbleClassDeleteOrder = new ArrayList<Class<?>>();
    private final static Object LOCK = new Object();

    public HibernateStoreSessionFactoryBuilder(Properties hibernateProperties, String mappingFilesDirectory) {
        super(hibernateProperties, mappingFilesDirectory);
    }

    public HibernateStoreSessionFactoryBuilder addResourceWithSubclasses(Class baseclass, Class... subclasses) {
    ...
    public HibernateStoreSessionFactoryBuilder addResourceWithSubclassesUsingRelativePath(String relativePath, Class baseclass, Class... subclasses) {
    ...
    public HibernateStoreSessionFactoryBuilder addResourceUsingAbsolutePath(Class clazz, String hbmFilename) {
    ...
    protected Configuration createConfiguration(Properties props) {
        ...
        ClassLoader cl = HibernateStoreSessionFactoryBuilder.class.getClassLoader();
        ...
        try {
            ...
            cfg.setInterceptor(new HibernateStoreInterceptor());
