 ...
 * @since 2.0
 */
public abstract class NonhistServerStoreModule extends ModuleWithStrategy<ServerStoreModuleStrategy> {
    private static Logger logger = LoggerFactory.getLogger(NonhistServerStoreModule.class);
    ...
    public NonhistServerStoreModule(ModuleConfiguration moduleConfiguration, Class<? extends StoreService> storeServiceClass, Class<? extends DBLockerService> dbLockerServiceClass, Class<? extends DBLockerInTransactionService> dbLockerInTransactionServiceClass, String mappingFileDirectoryRootDefault) {
    ...
    protected void configure() {
        ...
        bind(SessionFactory.class).toInstance(hibernateStoreSessionFactoryBuilder.build(new SnapshotVersionSeed(SnapshotVersion.CURRENT)));
