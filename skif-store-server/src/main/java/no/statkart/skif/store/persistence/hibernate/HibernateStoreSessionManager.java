 ...
 * @since 2.0
 */
public class HibernateStoreSessionManager implements StoreSessionManager {
    ...
    @Inject
    public HibernateStoreSessionManager(HibernateStoreSessionFactoryManager factoryManagerStore) {
    ...
    public void closeSession(ReplicaVersion replicaVersion) {
        if (hasActiveSession(replicaVersion)) {
            ...
            storeSessionWrapper.getHibernateSession().flush();
            storeSessionWrapper.getHibernateSession().close();
    ...
    public void beginTransaction() {
        ...
        localTranaction = storeSession.getHibernateSession().beginTransaction();
    }
    ...
    public Connection getConnection(ReplicaVersion replicaVersion, boolean allowSharing) {
        Connection connection = getSession(replicaVersion).getHibernateSession().connection();
