 ...
 */
public class HibernateStoreEJBResourceManager implements EJBResourceManager {
    private static Logger log = LoggerFactory.getLogger(HibernateStoreEJBResourceManager.class);
    ...
    @Inject
    public HibernateStoreEJBResourceManager(ServiceRequestContext serviceRequestContext, ConnectionManager connectionManager, ServiceMode serviceMode) {
