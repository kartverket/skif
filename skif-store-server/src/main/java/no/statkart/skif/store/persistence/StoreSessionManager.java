 ...
 * </p>
 * {@code StoreSessionManager} implementasjoner kan tilbyde en eller flere {@StoreSession}s som kan brukes parallelt.
 * Mest typisk er å tilbyd to {@code StoreSession} instanser, en for {@link SnapshotVersion#CURRENT} og en for
 * {@link SnapshotVersion#OLD} som bruker hver sin underliggende connection/session mot databasen.
 * </p>
 * For å begrense behovet for underliggende sessioner til to er api'et for bruk av {@code StoreSession} instanser
...
public interface StoreSessionManager extends ConnectionManager {
    ...
    /**
     * Henter ut en {@code StoreSession} med {@gitt SnapshotVersion} satt til gitt verdi.
     */
    StoreSession acquireSnapshotStoreSession(SnapshotVersion snapshotVersion);
