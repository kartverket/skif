...
public abstract class BubbleIdWithSnapshotVersionType extends SnapshotVersionType implements UserType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        if (rs.wasNull()) {
            ...
            return createId(value, getSnapshotVersion());
        }
    }
    ...
    public abstract Object createId(Long value, SnapshotVersion snapshotVersion);
}
