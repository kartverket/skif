...
public final class EntityKey implements Serializable {
	...
	public EntityKey(Serializable id, EntityPersister persister, EntityMode entityMode) {
        ...
        this.rootEntityName = getRootEntityName(persister);  // MODIFIED-BubbleRef: Modified to ensure rootEntityName is the same for EntityPersister and BubbleRefIdPersister
    ...
    // MODIFIED-BubbleRef BEGIN
    private static final Class bubbleRefIdPersisterClass;

    static {
       try {
           // TODO: denne bør endres til ikke å ha matrikkel i pakkenavn
          bubbleRefIdPersisterClass = Class.forName("no.statkart.matrikkel.persistens.hibernate.bubbleref.BubbleRefIdPersister");
