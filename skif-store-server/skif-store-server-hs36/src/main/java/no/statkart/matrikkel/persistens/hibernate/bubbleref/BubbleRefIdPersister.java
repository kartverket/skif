...
//                  return persistentClass;
    ...
    public BubbleRefIdPersister(PersistentClass persistentClass, final EntityRegionAccessStrategy cacheAccessStrategy, SessionFactoryImplementor factory, Mapping mapping) throws HibernateException {
        super(fix(persistentClass, mapping), cacheAccessStrategy, factory, mapping);
    ...
    /** Brukes av hibernate 3.6.10 */
    public Serializable getIdentifier(Object entity, SessionImplementor session) {
        if (entity instanceof BubbleObject) {
            return ((BubbleObject) entity).getId();
        } else {
