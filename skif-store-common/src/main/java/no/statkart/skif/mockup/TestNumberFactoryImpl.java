...
/**
 * Implementasjon av TestNumberFactory som gir mulighet for å angi hvilket offset som TestNumber objekter
 * skal bruke. Som default brukes {@code 10000}, men det kan endres ved eksplisitt å bind en opp en annen instans
 * i Guide
