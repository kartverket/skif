 ...
 */
public abstract class AbstractBubbleId<T extends AbstractBubbleObject> implements BubbleId<T>, Serializable {
    ...
    // static Map of meta info for each AbstractBubbleId class
    ...
    public AbstractBubbleId<T> resolveInstance() {
        return this;
    }
    ...
    protected AbstractBubbleId(Object value, ReplicaVersion version) {
        this.value = value;
    ...
    public AbstractBubbleId<T> fromIdValue(Object value, ReplicaVersion replicaVersion) {
        try {
    ...
    public AbstractBubbleId<T> asReplicaVersion(ReplicaVersion replicaVersion) {
    ...
    /**
     *
     * @throws ConfigurationException if class could not be found
     */
    public Class calcType() {
        ...
        try {
            ...
            throw new ConfigurationException("Could not load class " + className + " derived from " + this, e);
        }
    }
     ...
     * @throws ReflectionException if the type could not be created
     */
