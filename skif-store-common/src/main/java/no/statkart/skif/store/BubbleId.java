 ...
 * @since 0.6
 */
public abstract class BubbleId<T extends BubbleObject> implements BubbleIdInterface<T>, Serializable {
    ...
    protected BubbleId(Object value) {
        this.value = value;
    }
    ...
    public boolean equals(Object id) {
        return id instanceof BubbleId && equals((BubbleId) id);
    }
    ...
    final private boolean compatible(BubbleId id) {
    ...
    public int compareTo(Object object) {
        return getStringValue().compareTo(((BubbleId) object).getStringValue());
    }
