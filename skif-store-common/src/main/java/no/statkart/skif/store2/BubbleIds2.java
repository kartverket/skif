...
public class BubbleIds2 {
    ...
    public static <I extends BubbleId2<?>> I createInstance(Class<I> idClass, long idValue, ReplicaVersion replicaVersion) {
        return createInstance(idClass, new Long(idValue), replicaVersion);
    }

    public static <I extends BubbleId2<?>> I createInstance(Class<I> idClass, Object idValue, ReplicaVersion replicaVersion) {
        I id = null;
        try {
