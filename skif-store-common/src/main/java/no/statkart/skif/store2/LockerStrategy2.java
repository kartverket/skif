 ...
 * @since 0.3
 */
public interface LockerStrategy2 {
     ...
     */
    public boolean lock(BubbleId2 id, String owner) throws LockedException;
     ...
     */
    void unlock(BubbleId2 id, String owner);
     ...
     */
    public boolean isLockedBy(BubbleId2 id, String owner);
     ...
     */
    public boolean isLockedByOther(BubbleId2 id, String owner);
     ...
     */
    public void registerInserted(BubbleId2 id);
     ...
     */
    public void registerUpdated(BubbleId2 id, String owner);
     ...
     * @param owner Bruker id skal registreres for
     */
    public void registerRemoved(BubbleId2 id, String owner);
}
