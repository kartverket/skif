...
/**
 * Tester opprettelse av proxy-kjede for EJB.
 */
@Test(groups = "singlevm-required")
public class EjbChainTest {
    public void buildCustomChain() {
        ...
        Object instance = injector.getInstance(Key.get(Types.listOf(Types.newParameterizedType(ChainedProxyHandler.class, Test2Service.class))));
