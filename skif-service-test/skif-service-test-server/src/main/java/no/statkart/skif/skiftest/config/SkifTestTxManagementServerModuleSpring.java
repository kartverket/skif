...
import no.statkart.skif.service.module.server.ResourceWithSingleConnectionModuleSpring;
 ...
 * @since 2.0
 */
public class SkifTestTxManagementServerModuleSpring extends SkifModule {
    public SkifTestTxManagementServerModuleSpring(ModuleConfiguration configuration) {
        super(configuration);
    }
    ...
    protected void configure() {
        ...
        install(new ResourceWithSingleConnectionModuleSpring(moduleConfiguration));
    }
