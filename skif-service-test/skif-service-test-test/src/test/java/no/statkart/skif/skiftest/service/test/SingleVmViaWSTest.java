...
public class SingleVmViaWSTest extends SkifTestCase {
    ...
    public void testExceptionMapping() {
        try {
            test3Service.testThrowExcpetion("SimpleException", "Test");
    ...
    public static class ClientModule extends SkifModule {
        ...
        protected ModuleStrategyFactory defineDefaultModuleStrategyFactory() {
            ...
            clientModuleStrategyFactory.addPrototype(RemoteServiceModule.class, new StrategyTuple<>(null, RemoteServiceModuleStrategySingleVmXml.class));
