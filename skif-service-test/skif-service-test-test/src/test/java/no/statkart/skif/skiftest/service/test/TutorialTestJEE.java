...
public class TutorialTestJEE {
    ...
    public void testJaxWsClientServiceCreateUsingProviderBasic() throws Exception {
        ...
        injector = Guice.createInjector(
                ...
                new AbstractModule() {
                    ...
                    protected void configure() {
                        ...
                        bind(new TypeLiteral<ServiceContextMapper<?>>() {
                        }).to(SkifTestServiceContextMapper.class);

                        // Bind Mapping
                        bind(Mapping.class).toInstance(new IdentityMapper().getMapping());


                        bind(Test1Service.class).toProvider(new TypeLiteral<Provider<Test1Service>>() {
                        });


                        // Bind CallServiceChainFactory and support required support classes
                        bind(new TypeLiteral<TerminatingProxyHandler<Test1Service>>() {
                        }).
        ...
        injector = Guice.createInjector(
                ...
                new AbstractModule() {
                    ...
                    protected void configure() {
                        ...
                        bind(new TypeLiteral<TerminatingProxyHandler<Test1Service>>() {}).
                                to(new TypeLiteral<D2WAdapterWithServiceContextMapperProxyHandler<Test1Service, no.statkart.skif.skiftest.wsapi.service.test1.Test1Service>>() {});//
                        ServiceChainFactories.multibindFactory(binder(), CallServiceChainFactory.class, Test1Service.class, ClientCallServiceChainFactoryJEE.class);

                        // Bind ServiceProvider
                        bind(Test1Service.class).toProvider(new TypeLiteral<ServiceProvider<Test1Service>>(){});

                    }
//                    protected ServiceProvider<Test1Service> serviceProvider(Provider<no.statkart.skif.skiftest.wsapi.service.test1.Test1Service> wsServiceProvider, Mapping map) {
//                        new D2WAdapterProxyHandler<Test1Service,no.statkart.skif.skiftest.wsapi.service.test1.Test1Service>(wsServiceProvider,
//                                D2WAdapterProxyHandler<Test1Service,no.statkart.skif.skiftest.wsapi.service.test1.Test1Service>,map).buildProxy(Test1Service.class);
//
//                    }
                });
