...
public class PrioritetIkkeTinglystDokumentSidestiltMedId<T extends PrioritetIkkeTinglystDokumentSidestiltMed> extends PrioritetIkkeTinglystDokumentId<T> {
    ...
    public static PrioritetIkkeTinglystDokumentSidestiltMedId<?> create(long value) {
        return new PrioritetIkkeTinglystDokumentSidestiltMedId<PrioritetIkkeTinglystDokumentSidestiltMed>(new Long(value));
    }
}
