...
public class PrioritetIkkeTinglystDokumentVeketForId<T extends PrioritetIkkeTinglystDokumentVeketFor> extends PrioritetIkkeTinglystDokumentId<T> {
    ...
    public static PrioritetIkkeTinglystDokumentVeketForId<?> create(long value) {
        return new PrioritetIkkeTinglystDokumentVeketForId<PrioritetIkkeTinglystDokumentVeketFor>(new Long(value));
    }
}
