 ...
 * @since 0.6
 */
public class TestADbKode2 extends DbKodeImpl2 implements TestDbKode2 {

    @Override
    public TestADbKodeId2 getId() {
        return (TestADbKodeId2) super.getId();    //To change body of overridden methods use File | Settings | File Templates.
    }
}
