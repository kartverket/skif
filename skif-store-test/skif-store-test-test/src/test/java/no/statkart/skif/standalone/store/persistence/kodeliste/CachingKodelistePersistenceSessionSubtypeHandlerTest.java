...
public class CachingKodelistePersistenceSessionSubtypeHandlerTest {
    ...
    public CachingKodelistePersistenceSessionSubtypeHandlerTest() {
    ...
    private PersistenceSessionManager createPersistenceSessionManager() {
        ...
        // Oppretter en CachingKodelistePersister til bruk for SnapshotVersion.CURRENT
        return new DefaultPersistenceSessionManager(
                new DefaultPersistenceSessionStrategy(
                        masterCurrent,
                        new CachingKodelistePersistenceSessionSubtypeHandler(new DefaultKodelistePersistenceSessionSubtypeHandler(masterCurrent, enumKodelisteManager))
                ),
                new DefaultPersistenceSessionStrategy(
                        masterOld,
    ...
    public void testGetKodelister() {
        ...
        try {
            ...
            Collection<? extends KodelisteId<?>> kodelisteIds = kodelisteSubtypeHandler.getKodelisteIds();
