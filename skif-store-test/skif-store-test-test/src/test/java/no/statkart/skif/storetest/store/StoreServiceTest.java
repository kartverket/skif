...
public class StoreServiceTest extends StoreTestTestCase {
    ...
    public void testStoreService() {
        ...
        Collection<Simple> bubbles = storeService.getObjects(ids);
        assertEquals(1, bubbles.size());
        assertEquals(simple1Id, bubbles.iterator().next().getId());
    }
    ...
    // TODO Flyttes til egene testcaser for relasjoner og historikk
//
//    @Test
