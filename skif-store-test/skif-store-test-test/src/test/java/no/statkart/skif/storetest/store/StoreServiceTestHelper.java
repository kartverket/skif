...
public class StoreServiceTestHelper {
    public static StoreAndLockServiceTestImpl createStoreServiceWithNoObjects() {
        return createStoreServiceWithObjects();
    }

    public static StoreAndLockServiceTestImpl createStoreService(final Map<BubbleId<?>, BubbleObject> map) {
        return new StoreAndLockServiceTestImpl(map);
    }

    public static StoreAndLockServiceTestImpl createStoreServiceWithObjects(BubbleObject... objects) {
    ...
    public static class StoreAndLockServiceTestImpl implements StoreService, LockService {
        private final Map<BubbleId<?>, BubbleObject> map;

        public StoreAndLockServiceTestImpl(Map<BubbleId<?>, BubbleObject> map) {
            this.map = map;
        }
