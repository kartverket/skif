...
public class KodeSupportTest2 {
    ...
    public static class TestEnumKodeId2 extends EnumKodeIdImpl2<EnumKodeImpl2> {
        public TestEnumKodeId2(long value, ReplicaVersion2 replicaVersion) {
    ...
    public void testCreateKodeId() {
        KodeSupportHelper2 kodeSupport = new TestKodeSupport2(null, new KodelisteIdImpl2(5));
        KodeIdImpl2<KodeImpl2> id = kodeSupport.getInstance(new Long(1), ReplicaVersion2.CURRENT);
        assertNull(id);

        TestEnumKodeId2 id1 = new TestEnumKodeId2(1, ReplicaVersion2.CURRENT);
        KodeIdImpl2<EnumKodeImpl2> kodeId1 = kodeSupport.getOrCreateInstance(id1);
        assertSame(id1, kodeId1);

        TestEnumKodeId2 id1a = new TestEnumKodeId2(1, ReplicaVersion2.CURRENT);
    ...
    public void testNewKodeNotAllowed() {
        ...
        KodeIdImpl2<KodeImpl2> kodeId2 = kodeSupport.getInstance(new Long(2), ReplicaVersion2.CURRENT);
        assertNull(kodeId2);

        // Not ok to create new codes
        TestEnumKodeId2 id2 = new TestEnumKodeId2(2, ReplicaVersion2.CURRENT);
        try {
        ...
        TestEnumKodeId2 id1_old = new TestEnumKodeId2(1, ReplicaVersion2.OLD);
        ...
        TestEnumKodeId2 id2_old = new TestEnumKodeId2(2, ReplicaVersion2.OLD);
        try {
