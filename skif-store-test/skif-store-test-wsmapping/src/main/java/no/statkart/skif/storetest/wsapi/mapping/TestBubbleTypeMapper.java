 ...
 * @since 0.3
 */
public class TestBubbleTypeMapper<WsapiT extends no.statkart.skif.storetest.wsapi.domain.TestBubble, DomainT extends TestBubble> extends StoreTestBubbleTypeMapper<WsapiT,DomainT> {
