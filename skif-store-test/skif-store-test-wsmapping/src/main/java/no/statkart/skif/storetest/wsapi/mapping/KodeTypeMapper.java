...
import no.statkart.skif.storetest.domain.TestKode;

/**
 * @author Henrik Fredholm
 * @since 0.3
 */
public class KodeTypeMapper<WsapiT extends no.statkart.skif.storetest.wsapi.domain.kodeliste.Kode, DomainT extends TestKode> extends StoreTestBubbleTypeMapper<WsapiT,DomainT> {
