...
public class BubbleRefIdClass extends RootClass {
    ...
    public BubbleRefIdClass(PersistentClass c) {
        ...
        setEntityName(name);
        setClassName(name);
        setIdentifierProperty(c.getIdentifierProperty());
        c.getIdentifierProperty().setPersistentClass(c); // Reset persistent class back to c; was overwritten in setIdentifierProperty().
