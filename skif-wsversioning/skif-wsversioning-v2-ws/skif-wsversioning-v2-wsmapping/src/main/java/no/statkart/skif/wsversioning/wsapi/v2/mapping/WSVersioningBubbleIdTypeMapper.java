 ...
 * @since 2.4.0
 */
public class WSVersioningBubbleIdTypeMapper<WsapiT extends no.statkart.skif.wsversioning.wsapi.v2.domain.WSVersioningBubbleId, DomainT extends WSVersioningBubbleId> extends AbstractWSVersioningTypeMapper<WsapiT,DomainT> {
