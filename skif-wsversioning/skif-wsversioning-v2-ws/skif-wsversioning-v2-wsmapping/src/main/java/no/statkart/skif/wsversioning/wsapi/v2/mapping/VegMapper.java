 ...
 * @since 2.4.0
 */
public class VegMapper extends AbstractWSVersioningTypeMapper<no.statkart.skif.wsversioning.wsapi.v2.domain.Veg, Veg> {
    ...
    public VegMapper(Provider<ServiceContext> serviceContextProvider) {
        super(no.statkart.skif.wsversioning.wsapi.v2.domain.Veg.class, Veg.class);
    ...
    public no.statkart.skif.wsversioning.wsapi.v2.domain.Veg mapDomainObject(Veg source) {
        ...
        no.statkart.skif.wsversioning.wsapi.v2.domain.Veg target = getMapping().getDefaultTypeMapping().mapDomainObject(source, TypeToken.of(no.statkart.skif.wsversioning.wsapi.v2.domain.Veg.class));
    ...
    public Veg mapWsapiObject(no.statkart.skif.wsversioning.wsapi.v2.domain.Veg source) {
        ...
        Veg target = getMapping().getDefaultTypeMapping().mapWsapiObject(source, TypeToken.of(Veg.class));
        return target;
    }
}
