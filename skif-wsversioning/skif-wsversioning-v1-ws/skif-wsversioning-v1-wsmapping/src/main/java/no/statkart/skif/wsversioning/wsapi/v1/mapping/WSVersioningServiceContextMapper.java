...
public class WSVersioningServiceContextMapper extends AbstractServiceContextMapper<WSVersioningContext> {
    ...
    @Override
    public WSVersioningContext createWSServiceContextFromDomainServiceContext() {
    ...
    @Override
    public void setDomainServiceContextFromWSServiceContext(WSVersioningContext apiContext) {
        ServiceContext serviceContext= serviceContextProvider.get();
