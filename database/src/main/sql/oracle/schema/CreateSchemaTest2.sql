...
COMMENT ON ENTITY_COMPONENT IS 'Komponent for bobble';
...
COMMENT ON BUBBLE_W_ENTITY_COMPS IS 'Objekt med èn EntityComponent';
...
COMMENT ON ListOfEntityComponents IS 'Bobble med liste av mange EntityComponent';
...
COMMENT ON LISTOFENTITYCOMPONENTS__C IS 'Element i liste av komponenter for bobble';
